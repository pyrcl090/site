...
img4.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "merch design for pral <br> Photography: Joaquim bayle + Robin Watine";
});
...
section5.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "yasashii";
    imgcaption.innerHTML = "Exhibition design of 30 anagama ceramic pieces made by Clement Bossard during an apprenticeship with Toru Hatta in Japan.";
});
