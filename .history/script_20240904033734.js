...
img10.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "Worked with Hyung Cho, 132 Studio, and Alex Lavertue on GE Employee Handbook in recognition<br>Photos courtesy of 132 studio and Hyung cho.";
});
