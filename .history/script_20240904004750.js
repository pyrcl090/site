...
section5.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "yasashii";
    imgcaption.innerHTML = "<br>Exhibition design for 30 anagama ceramic pieces made by Clement Bossard during an apprenticeship with Toru Hatta in Japan.";
});
...
img6.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br>merch design for pral";
});
