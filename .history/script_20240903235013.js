...
img1.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "la braderie <br>(POSTER)";
    imgcaption.innerHTML = "<br><br>For la braderie (yard sale) at pral.";
});
section1.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "la braderie (POSTER)";
    imgcaption.innerHTML = "Poster for la braderie (yard sale) at pral.";
});
