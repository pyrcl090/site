...
img10.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br>Assisted Hyung Cho, 132 Studio, and Alexander Lavertue on GE Employee Handbook in recognition of the history and accomplishments of GE. <br>Photos courtesy of 132 studio and Hyung cho.";
});
