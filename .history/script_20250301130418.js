...
img11.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "Digit-al Exercises";
    imgcaption.innerHTML = "<br><br>2025 Holiday Card and website for No Ideas.";
});
...
img11.addEventListener("click", function(){
    ...
    section11.scrollIntoView({behavior: 'smooth', block: 'start'}); 
...
img10.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br><br>Website for freelance Paris based executive producer Alix Demoussis.";
});
...
img3.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br>branding for polish customizeable tinned herring company.";
});
...
img4.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br>merch design and assistant creative direction for pral. Photography by Joaquim bayle + Robin Watine.";
});
...
img5.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br>Exhibition design for anagama ceramic pieces made by Clement Bossard during an apprenticeship with Toru Hatta in Japan.";
});
...
img6.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br>Recipe books are archives of taste, method, and history. With this generative recipe book, these factors become distorted changing the methods and outcomes of the traditional recipe book.";
});
...
img7.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br>Asks participants to analyze examples of conservation-destruction relationships. A bilingual and biannual subscription delivered through a series of screenings accompanied by printed books, (e) utilizes the visual language of the tools it critiques.";
});
...
img8.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br>Is a book exploring bit rot and digital decay.";
});
...
img9.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br><br>Phase Zero Issue 8 Launch flyer.";
});
...
img12.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "cOquetiphile";
    imgcaption.innerHTML = "<br<br>>Website for ceramic project cOq.";
});
section12.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "cOquetiphile";
    imgcaption.innerHTML = "<br>Website for ceramic project cOq.";
});
