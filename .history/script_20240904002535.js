...
img1.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br> 2024 <br>Poster for la braderie (yard sale) at pral.";
});
...
img2.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "extreme 38° italic typeface based on polish folklore sirens by the same name";
});
...
img3.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "branding for polish customizeable tinned herring company śledź.";
});
...
img4.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br>merch design and assistant creative direction for pral <br> Photography: Joaquim bayle + Robin Watine";
});
section4.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "pral FW24";
    imgcaption.innerHTML = "merch design and assistant creative direction for pral <br> Photography: Joaquim bayle + Robin Watine";
});
...
img5.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "<br>Exhibition design of 30 anagama ceramic pieces made by Clement Bossard during an apprenticeship with Toru Hatta in Japan.";
});
...
img6.addEventListener("mouseover", function(){
    ...
    imgcaption.innerHTML = "merch design for pral";
});
