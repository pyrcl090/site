...
img7.addEventListener("mouseover", function(){
    imgtxt.innerHTML = "(e) project";
    imgcaption.innerHTML = "<br> workshop series Project (e) asks participants to analyze examples of this conservation-destruction relationship. A bilingual and biannual subscription delivered through a series of screenings accompanied by printed books, (e) utilizes the visual language of the tools it critiques.";
});
